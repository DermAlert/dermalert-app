...
export default function PersonalFamilyHistoryEditStep4() {
  ...
  const handleNext = (data: PersonalFamilyHistoryProps) => {
    if (data.injuries_treatment && data.injuries_treatment.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/personalFamilyHistory/edit/step5');
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text className="text-base text-neutral-800 mt-4 mb-8">O paciente já passou por tratamento para lesões na pele?</Text>
              ...
              <View className="gap-3">
                <View>
                  ...
                  <Animated.View style={animatedStyle}>
                    ...
                    >
                      <Text className="px-0 mt-5 text-neutral-900 text-base">Qual foi o tratamento?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/personalFamilyHistory/edit/step3')} 
