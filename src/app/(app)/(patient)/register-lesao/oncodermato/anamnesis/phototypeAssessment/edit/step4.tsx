...
export default function PhototypeAssessmentEditStep4() {
  ...
  const handleNext = (data: PhototypeAssessmentProps) => {
    if (data.freckles && data.freckles.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/phototypeAssessment/edit/step5');
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text allowFontScaling={false} className="text-base text-neutral-800 mt-4 mb-8">Quantas sardas o paciente tem em áreas não expostas?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/phototypeAssessment/edit/step3')} 
