...
export default function CancerResearchEditStep5() {
  ...
  const handleNext = (data: CancerResearchProps) => {
    if (data.diagnosis && data.diagnosis.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/cancerResearch/edit/step6');
    } else {
      return;
    }
  }
    ...
    >
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/cancerResearch/edit/step4')} 
