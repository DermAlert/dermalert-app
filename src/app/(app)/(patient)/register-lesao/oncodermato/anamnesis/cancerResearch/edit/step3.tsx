...
export default function CancerResearchEditStep3() {
  ...
  const handleNext = (data: CancerResearchProps) => {
    if (data.how_long && data.how_long.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/cancerResearch/edit/step4');
    } else {
      return;
    }
  }
    ...
    >
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/cancerResearch/edit/step2')} 
