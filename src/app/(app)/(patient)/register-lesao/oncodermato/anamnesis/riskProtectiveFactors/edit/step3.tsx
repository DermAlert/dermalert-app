...
export default function RiskProtectiveFactorsEditStep3() {
  ...
  const handleNext = (data: RiskProtectiveFactorsProps) => {
    if (data.uv_protection && data.uv_protection.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/riskProtectiveFactors/edit/step4');
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text allowFontScaling={false} className="text-base text-neutral-800 mt-4 mb-8">O paciente usa protetor solar regularmente? Se sim, qual FPS?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/oncodermato/anamnesis/riskProtectiveFactors/edit/step2')} 
