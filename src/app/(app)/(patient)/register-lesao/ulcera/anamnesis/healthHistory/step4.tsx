...
export default function UlceraHealthHistoryStep4() {
  ...
  const handleNext = (data: UlceraHealthHistoryProps) => {
    if (data.chronic_venous_insufficiency && data.chronic_venous_insufficiency.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/healthHistory/step5')
    } else {
      return;
    }
  }
    ...
    >
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/healthHistory/step3')} 
