...
export default function UlceraRiskLifestyleEditStep4() {
  ...
  const handleNext = (data: UlceraRiskLifestyleProps) => {
    if (data.physical_activity && data.physical_activity.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/edit/step5')
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text allowFontScaling={false} className="text-base text-neutral-800 mt-4 mb-8">O paciente pratica alguma atividade física regularmente?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/edit/step3')} 
