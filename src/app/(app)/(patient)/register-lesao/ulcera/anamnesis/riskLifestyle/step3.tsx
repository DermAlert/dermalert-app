...
export default function UlceraRiskLifestyleStep3() {
  ...
  const handleNext = (data: UlceraRiskLifestyleProps) => {
    if (data.smoking && data.smoking.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/step4')
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text className="text-base text-neutral-800 mt-4 mb-8">O paciente fuma ou já fumou?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/step2')} 
