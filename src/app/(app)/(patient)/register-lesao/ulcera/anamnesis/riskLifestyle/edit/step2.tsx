...
export default function UlceraRiskLifestyleEditStep2() {
  ...
  const handleNext = (data: UlceraRiskLifestyleProps) => {
    if (data.leg_foot_trauma && data.leg_foot_trauma.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/edit/step3')
    } else {
      return;
    }
  }
    ...
    >
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/riskLifestyle/edit/step1')} 
