...
export default function UlceraUlcerInfoStep3() {
  ...
  const handleNext = (data: UlceraUlcerInfoProps) => {
    if (data.used_antibiotics && data.used_antibiotics.length > 0 && notEmpty) {
      ...
      router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/ulcerInfo/step4')
    } else {
      return;
    }
  }
  ...
  return (
    ...
    >
      ...
      <ScrollView className="px-8 w-full flex-1">
        ...
        <Text className="text-base text-neutral-800 mt-4 mb-8">O paciente já usou antibióticos para tratar essa ferida?</Text>
      ...
      <View className="gap-4 mt-4 px-8 w-full justify-start mb-4 flex-row">
        <Button title="Voltar" 
          ...
          onPress={()=> router.push('/(app)/(patient)/register-lesao/ulcera/anamnesis/ulcerInfo/step2')} 
