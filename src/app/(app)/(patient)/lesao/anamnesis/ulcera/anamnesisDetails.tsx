      ...
      <View className="px-5 py-6 w-full justify-start flex-1 gap-[10]">
        ...
        >
          ...
          <View className="flex-1">
            <Text className="text-base text-neutral-900">Histórico clínico geral</Text>
          </View>          
        ...
        >
          ...
          <View className="flex-1">
            <Text className="text-base text-neutral-900">Fatores de risco e estilo de vida</Text>
          </View>          
          <CaretRightIcon size={18} color="#7D83A0" weight="bold" />
        </TouchableOpacity>
        ...
        >
          ...
          <View className="flex-1">
            <Text className="text-base text-neutral-900">Histórico familiar</Text>
          </View>          
          <CaretRightIcon size={18} color="#7D83A0" weight="bold" />
        </TouchableOpacity>
        ...
        >
          ...
          <View className="flex-1">
            <Text className="text-base text-neutral-900">Informações sobre a úlcera atual</Text>
          </View>          
          <CaretRightIcon size={18} color="#7D83A0" weight="bold" />
        </TouchableOpacity>
        ...
        >
          ...
          <View className="flex-1">
            <Text className="text-base text-neutral-900">Acesso a cuidados e suporte</Text>
          </View>          
          <CaretRightIcon size={18} color="#7D83A0" weight="bold" />
        </TouchableOpacity>
