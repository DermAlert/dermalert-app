  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text className="text-neutral-900 text-lg font-medium">Fototipo {phototype?.phototype}</Text>
      </View>
      ...
      >
        ...
        <Text className="text-neutral-900 text-lg font-medium">{phototype?.score}</Text>
      </View>
